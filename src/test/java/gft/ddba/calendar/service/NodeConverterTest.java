...
public class NodeConverterTest {
	...
	public void shouldIterableAfterConvertionContainKingObject() {
		...
		Iterable<String> iterableNode = NodeConverter.convertTreeToIterableStream(kingdom);
	...
	public void shouldThrowIllegalArgumentExceptionWhenRoorIsNull() {
		...
		NodeConverter.convertTreeToIterableStream(kingdom);
	...
	@Test
	public void shouldSubscriberContainAllTheValuesOFTheTreeStructure() {
		Node<String> kingdom = new Royalty("kingdom");
		Node<String> king = new Royalty("king");
		...
		Observable<String> iterableObservable = converter.convertTreeToObservableStream(kingdom);
	...
	public void shouldReturnEmptyComplitedStream() {

		Observable<String> iterableObservable = converter.convertTreeToObservableStream(null);
